<main id="main" class="main">
    <section class="section">
        ...
        <div class="row">
            <div class="col-lg-12">
                <form action="<?= site_url('inventory/publish') ?>" method="POST">
                        ...
                        <tbody>
                            <?php foreach ($inventoryItems as $item): ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php if ($item['status'] === 'not published'): ?>
                    ...
                    <!-- Profit Percentage and Publish Button -->
                    <div class="row mt-3">
                        <div class="col-md-4">
                            <input type="number" name="profit_percentage" class="form-control" placeholder="Profit Percentage" required>
                        </div>
                        <div class="col-md-4">
                            <button type="submit" class="btn btn-success">Publish Selected Items</button>
                        </div>
                    </div>
                </form>
            </div>
