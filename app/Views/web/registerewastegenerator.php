    ...
    <body>
            ...
            <section id="contact" class="contact">
                <div class="container" data-aos="fade-up">
                    ...
                    <div class="section-title">
                        <h2>Register as E-waste Generator</h2>
                        <p>Follow the steps below to accurately fill out the E-waste Generator registration form. Ensure that all fields are completed to create a unique and secure profile.</p>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-5 d-flex align-items-stretch">
                            <div class="info">
                                <div class="info" style="border: none;">
                                    <h4 style="border: none;">How to Register as an E-waste Generator</h4>
                                    <p>Follow the steps in the registration form to create your unique and secure profile. Make sure to fill in all the required fields, including your personal, contact, and address details. Review the information carefully before submitting.</p>
                                </div>


                                <img src="<?= base_url('public/assets_web/img/generator.jpg') ?>" alt="Generator Image" style="border:0; width: 100%; height: 290px;">
                        ...
                        <div class="col-lg-7 mt-5 mt-lg-0 d-flex align-items-stretch">
                            ...
                            <?php helper(' form'); ?>
                            <?= form_open_multipart('web/save_ewaste_generator', ['novalidate' => '', 'role' => 'form', 'class' => 'php-email-form']); ?>
                            ...
                            <div class="form-group">
                                <label for="formFile">Upload Your Profile Image</label>
        ...
        <footer id="footer">
            ...
            <div class = "container footer-bottom clearfix">
                <div class = "copyright">
                    &copy;
                    Copyright <strong><span>E-Waste Management System</span></strong>. All Rights Reserved
                </div>
                <div class = "credits">
