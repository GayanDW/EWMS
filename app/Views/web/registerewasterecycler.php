            ...
            <section id="contact" class="contact">
                <div class="container" data-aos="fade-up">
                    ...
                    <div class="section-title">
                        <h2>Register as E-waste Recycler</h2>
                        <p>Follow the steps below to accurately fill out the E-waste Recycler registration form. Ensure that all fields are completed to create a unique and secure profile.</p>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-5 d-flex align-items-stretch">
                            <div class="info">
                                <div class="info" style="border: none;">
                                    <h4 style="border: none;">How to Register as an E-waste Recycler</h4>
                                    <p>Follow the steps in the registration form to create your unique and secure profile. Make sure to fill in all the required fields, including your business, contact, and recycling capabilities. Review the information carefully before submitting.</p>
                                </div>

                                <!-- Keep the image related code same -->
                                <img src="/ewms/public/assets_web/img/recycler.jpg" alt="Recycler Image" style="border:0; width: 100%; height: 290px;">
                        ...
                        <div class="col-lg-7 mt-5 mt-lg-0 d-flex align-items-stretch">
                            ...
                            <?php helper('form'); ?>
                            <?= form_open_multipart('web/save_ewaste_recycler', ['novalidate' => '', 'role' => 'form', 'class' => 'php-email-form']); ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control" name="profile_image" id="profile_image" value="<?= set_value('profile_image') ?>" required>
